...
<body style="height:950px;">
    ...
    <div class="content_back_color">
            ...
            <div class="container" style="height:2%;">
               <nav aria_label="breadcrumb breadcrumbback" style="height:2.2rem;">
                    <ol class="breadcrumb pro_det_bre">
                        ...
                        <li class="breadcrumb-item active"><a>商品录入(带  *必填)</a></li>
                    </ol>
                </nav>
        ...
        <form id = "Pro_details" class="form-horizontal" action="Product_add.action?shopkeeperId=${user.ID}" method="post" enctype="multipart/form-data">
                            ...
                            <!-- 图片显示-->
                                <div class="col-md-5 float-right" style="height:100%;" id="img-thumb">
                                    <div class="col-md-12 img-thum_out_con" >
                                        <img src="<%=basePath%>JSP/lib/bootstrap/img/init.jpg" id="view0" class="img-thumbnail img-thum_con" data-toggle="tooltip" data-placement="bottom" title="点击查看大图">
...
<!--                                             <input type="text" class="form-control col-md-8" placeholder="软件工程" name="major"> -->
                                            <select name="major" class="form-control col-md-8">
											    <option value="0" selected="selected">请选择适合专业</option>
                                        ...
                                        <div class="form-group input-group text-right pro_details_txt">
                                             ...
                                             <input type="text" value="1" class="form-control col-md-2" placeholder="0" name="Pro_num">
                                        </div>
                                </fieldset>
                            </div>
                        </div>
